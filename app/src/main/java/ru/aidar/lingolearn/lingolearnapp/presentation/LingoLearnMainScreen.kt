...
import ru.aidar.lingolearn.utils.Constants.NUMBER_OF_NAVIGATION_IN_COLUMN
import ru.aidar.lingolearn.utils.Constants.ROUTE_STRING_DRAW_RES_MAIN_MENU
...
fun ColumnScope.MainScreenNavigation(
    ...
    repeat(NUMBER_OF_NAVIGATION_IN_COLUMN) {
        Row(
            modifier = modifier
                .clickable { navigateTo(ROUTE_STRING_DRAW_RES_MAIN_MENU[it].route) },
            horizontalArrangement = Arrangement.SpaceBetween,
            verticalAlignment = Alignment.CenterVertically,
        ) {
            InformationInRow(
                drawableResource = ROUTE_STRING_DRAW_RES_MAIN_MENU[it].drawRes,
                stringResource = ROUTE_STRING_DRAW_RES_MAIN_MENU[it].stringRes,
                tint = tint
            )
        }
    }
    /* Row(
     ...
     Row(
         ...
         InformationInRow(
             drawableResource = R.drawable.nav_translate,
     ...
     Row(
         ...
         InformationInRow(
             drawableResource = R.drawable.nav_profile,
